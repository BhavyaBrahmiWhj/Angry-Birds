...
function draw() {
  ...
  if (pig1.visibility <= 0 && pig2.visibility <= 0 && gameState == "detached") {
    gameState = "WIN";
    noStroke();
    textSize(100);
    fill("white");
...
async function setBackgroundImage() {
  ...
  if (hour >= 06 && hour < 18) {// 6 am to 5 pm  06 to 17
    console.log("inside morning condition: " );
    imagePath = "images/day.png";
  }
  else {// 6 pm to 5 am  18 to 05
    console.log("inside night condition: " );
